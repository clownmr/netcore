...
using Com.SSO.AuthenticationServer.Models.AccountViewModels;
using Com.SSO.AuthenticationServer.Services;

namespace Com.SSO.AuthenticationServer.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    /// 了解如何使客户确认和密码重置请访问http://go.microsoft.com/fwlink/？linkid = 532713
                    //用这个链接发送一封电子邮件
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            //下面的代码可以保护对两个因素代码的蛮力攻击。
            //如果一个用户在指定的时间内输入不正确的代码，那么用户帐户
            //将被锁在一个指定的时间内。
